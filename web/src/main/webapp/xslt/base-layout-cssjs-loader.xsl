...
<link href="{/root/gui/url}/static/gn_search_default.css{$minimizedParam}" rel="stylesheet" media="screen" />
<link href="{/root/gui/url}/static/gn_view.css{$minimizedParam}" rel="stylesheet" media="screen" />
