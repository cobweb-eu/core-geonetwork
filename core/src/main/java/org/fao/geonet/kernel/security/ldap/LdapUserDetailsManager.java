...
/**
 * Made this class because of the stupid implementation of
 * {@link org.springframework.security.ldap.userdetails.LdapUserDetailsManager#setGroupMemberAttributeName(String)}
 *
 *
 * 
 * @author delawen
...
public class LdapUserDetailsManager implements UserDetailsManager {
	...
	/**
	 * The strategy for mapping usernames to LDAP distinguished names. This will
	 * be used when building DNs for creating new users etc.
	 */
	...
	/**
	 * The strategy used to create a UserDetails object from the LDAP context,
	 * username and list of authorities. This should be set to match the
	...
	/**
	 * Default context mapper used to create a set of roles from a list of
	 * attributes
	 */
	...
	/**
	 * Changes the password for the current user. The username is obtained from
	 * the security context.
	 * <p>
	 * If the old password is supplied, the update will be made by rebinding as
	 * the user, thus modifying the password using the user's permissions. If
	 * <code>oldPassword</code> is null, the update will be attempted using a
	 ...
	 *
	 * @param dn
	 *            the distinguished name of the entry - may be either relative
	 *            to the base context or a complete DN including the name of the
	 *            context (either is supported).
	 * @param username
	 *            the user whose roles are required.
...
//		addAuthorities(dn, user.getAuthorities());
	...
	/**
	 * Sets the name of the multi-valued attribute which holds the DNs of users
	 * who are members of a group.
	 * <p>
	 * Usually this will be <tt>uniquemember</tt> (the default value) or
	 * <tt>member</tt>.
	 * </p>
	 *
	 * @param groupMemberAttributeName
